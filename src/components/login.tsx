      ...
      <div className="hidden lg:flex flex-col justify-center p-8 bg-gradient-to-br from-[hsl(35,93%,64%)] to-[hsl(35,93%,45%)] text-zinc-900">
        <div className="w-full mx-auto space-y-12">
          <div className="space-y-2">
            ...
            <p className="text-zinc-800 max-w-4xl">
          ...
          <div className="bg-white/20 backdrop-blur-sm p-6 rounded-lg max-w-4xl">
            <blockquote className="text-sm italic text-zinc-900">
              &quot;Thank you for the opportunity to showcase my work. This
              project reflects my dedication to building seamless, accessible
              applications that put user experience first. I&apos;ve thoroughly
              enjoyed creating this demo and would be excited to bring this same
              passion and attention to detail to the Fetch team.&quot;
            </blockquote>
            <div className="mt-4">
              <p className="font-medium">David Mostoller</p>
              <p className="text-sm text-zinc-800">Software Engineer</p>
            </div>
          </div>
        </div>
      </div>
