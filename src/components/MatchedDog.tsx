...
export function MatchedDog({ dog, onReset }: MatchedDogProps) {
  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center py-4 sm:p-6">
        <motion.div
        ...
        >
          <Card className="w-full max-w-2xl mx-auto overflow-hidden mb-8">
            ...
            <CardContent className="relative -mt-32 bg-gradient-to-b from-transparent to-background p-4 sm:p-8">
              <motion.div
                className="space-y-6"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
