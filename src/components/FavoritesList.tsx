...
const FavoritesList = () => {
  ...
  return (
    <div className="max-w-screen-2xl space-y-6 px-4">
        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Button
              ...
              onClick={handleMatch}
              disabled={isMatching || !dogs?.length}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-4 text-center">
            <CardHeader>
